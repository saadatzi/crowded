...
const limitPage = (settingController.getByKey('Number of lists (limitation per page)')).value
console.error("////////////////////////////// limitPage: ", limitPage);
...
module.exports = {
	...
	panel: {
		defaultLimitPage: limitPage && !isNaN(limitPage) ? parseInt(limitPage) : 20
	},
	notification: (value) => {
		return {
			approval: {
